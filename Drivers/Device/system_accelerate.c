...
*/
void System_InvalidateIAccelerate_by_Addr (volatile void *addr, uint32_t isize)
{
    if ( isize > 0 ) {
...
* Author      : Chris_Kyle                         Data : 2020定
**********************************************************************************/
void System_InvalidateDAccelerate_by_Addr (volatile void *addr, uint32_t dsize)
{
    if ( dsize > 0 ) {
       uint32_t op_size = dsize + (((uint32_t)addr) & (__SCB_DCACHE_LINE_SIZE - 1U));
...
* Author      : Chris_Kyle                         Data : 2020
**********************************************************************************/
void System_CleanDAccelerate_by_Addr (volatile void *addr, uint32_t dsize)
{
    if ( dsize > 0 ) {
       uint32_t op_size = dsize + (((uint32_t)addr) & (__SCB_DCACHE_LINE_SIZE - 1U));
      uint32_t op_addr = (uint32_t)addr /* & ~(__SCB_DCACHE_LINE_SIZE - 1U) */;
...
* Author      : Chris_Kyle                         Data : 2020
**********************************************************************************/
void System_CleanInvalidateDAccelerate_by_Addr (volatile void *addr, uint32_t dsize)
{
    if ( dsize > 0 ) {
       uint32_t op_size = dsize + (((uint32_t)addr) & (__SCB_DCACHE_LINE_SIZE - 1U));
      uint32_t op_addr = (uint32_t)addr /* & ~(__SCB_DCACHE_LINE_SIZE - 1U) */;
