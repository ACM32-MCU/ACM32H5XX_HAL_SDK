...
#define IC_H528VIT7_G       0x1C53 //LQFP100,  FLASH(1) 2MB
#define IC_H538VMT6_TM      0x9E21 //LQFP100,  FLASH(1) 4MB, PSRAM8(rst-pn0) 8MB
#define IC_H528ZIT7_G       0x6B63 //LQFP144,  FLASH(1) 2MB
#define IC_H538ZMT6_TM      0xE911 //LQFP144,  FLASH(1) 4MB, PSRAM8(rst-pn0) 8MB
#define IC_H528IIT7_G       0xC2EF //LQFP176,  FLASH(1) 2MB
#define IC_H539IMT6SPM      0x3851 //ELQFP176, FLASH(0) 4MB, PSRAM8(rst-pn6) 8MB

#ifndef ACM32D5XX
    #define IC_H538VMT6_TM_2    0x9500 //LQFP100,  FLASH(1) 4MB, PSRAM8(rst-pn0) 8MB
    #define IC_D539IMT6SPM      0x9D56 //ELQFP176, FLASH(0) 4MB, PSRAM8(rst-pn6) 8MB
    #define IC_D559IQH6_PE      0x1CCC //BGA176,   FLASH(0) 8MB, SDRAM16 32MB
    #define IC_D559XQH6_PE      0x10B1 //BGA240,   FLASH(0) 8MB, SDRAM16 32MB
    #define IC_D569XQH6_PE      0xB8D0 //BGA240,   FLASH(0) 8MB, SDRAM32 64MB
#else
    #include "acm32d5xx_ic_code.h"
#endif
...
#define SRAM1_BASE_ADDR                 ( SRAM_BASE_ADDR + 0x00008000UL )   //SIZE 192KB WITH ECC
#define SRAM2_BASE_ADDR                 ( SRAM_BASE_ADDR + 0x00038000UL )   //SIZE 128KB WITHOUT ECC
#define SRAM3_BASE_ADDR                 ( SRAM_BASE_ADDR + 0x00058000UL )   //SIZE 32KB WITH ECC,END ADDR 0x0005FFFF
...
#define ADC12_COMMON                    ( (ADC12_Common_TypeDef *)(ADC1_BASE_ADDR + 0x0300UL) )
#define ADC3                            ( (ADC_TypeDef *)ADC3_BASE_ADDR )
#define ADC3_COMMON                     ( (ADC3_Common_TypeDef *)(ADC3_BASE_ADDR + 0x0300UL) )
...
#define TKEY_IER_CHGDONEIE                                  ( TKEY_IER_CHGDONEIE_Msk )
...
#define TKEY_TSETR_TSET_Pos                                 ( 4U )
#define TKEY_TSETR_TSET_Msk                                 ( 0xfffUL << TKEY_TSETR_TSET_Pos )
#define TKEY_TSETR_TSET                                     ( TKEY_TSETR_TSET_Msk )
#define TKEY_TSETR_TSET_0                                   ( 0x1UL << TKEY_TSETR_TSET_Pos )
#define TKEY_TSETR_TSET_1                                   ( 0x2UL << TKEY_TSETR_TSET_Pos )
#define TKEY_TSETR_TSET_2                                   ( 0x4UL << TKEY_TSETR_TSET_Pos )
#define TKEY_TSETR_TSET_3                                   ( 0x8UL << TKEY_TSETR_TSET_Pos )
#define TKEY_TSETR_TSET_4                                   ( 0x10UL << TKEY_TSETR_TSET_Pos )
#define TKEY_TSETR_TSET_5                                   ( 0x20UL << TKEY_TSETR_TSET_Pos )
#define TKEY_TSETR_TSET_6                                   ( 0x40UL << TKEY_TSETR_TSET_Pos )
#define TKEY_TSETR_TSET_7                                   ( 0x80UL << TKEY_TSETR_TSET_Pos )
...
/*------------------  D5XX specific peripherals Definition  ------------------*/
