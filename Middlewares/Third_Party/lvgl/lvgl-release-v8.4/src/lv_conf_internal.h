...
/*Use ACM32's DMA2D (aka Chrom Art) GPU*/
#ifndef LV_USE_GPU_ACM32_DMA2D
    #ifdef CONFIG_LV_USE_GPU_ACM32_DMA2D
        #define LV_USE_GPU_ACM32_DMA2D CONFIG_LV_USE_GPU_ACM32_DMA2D
    #else
        #define LV_USE_GPU_ACM32_DMA2D 0
    #endif
#endif
	...
	#ifndef LV_GPU_DMA2D_CMSIS_INCLUDE
		#ifdef CONFIG_LV_GPU_DMA2D_CMSIS_INCLUDE
			#define LV_GPU_ACM32_DMA2D_CMSIS_INCLUDE CONFIG_LV_GPU_DMA2D_CMSIS_INCLUDE
		#else
            #define LV_GPU_DMA2D_CMSIS_INCLUDE	"acm32h5xx.h"
		#endif
	#endif
#endif
