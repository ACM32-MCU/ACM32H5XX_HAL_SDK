...
#include "../draw/acm32_dma2d/lv_gpu_acm32_dma2d.h"
...
#elif LV_USE_GPU_ACM32_DMA2D
	driver->draw_ctx_init = lv_draw_acm32_dma2d_ctx_init;
	driver->draw_ctx_deinit = lv_draw_acm32_dma2d_ctx_deinit;
	driver->draw_ctx_size = sizeof(lv_draw_acm32_dma2d_ctx_t);
#else
