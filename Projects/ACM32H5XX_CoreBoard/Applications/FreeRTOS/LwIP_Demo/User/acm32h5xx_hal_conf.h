...
#ifndef __ACM32H5XX_HAL_CONF_H
#define __ACM32H5XX_HAL_CONF_H
...
#define TICK_PERIOD_100MS           (100U)
#define TICK_PERIOD_MS              (TICK_PERIOD_10MS)
