...
#if (USB_OTG_VER==USB_OTG_VER13)
#define  USB_LEN_OTG_DESC							   	   0x03U
#elif (USB_OTG_VER==USB_OTG_VER20)
#define  USB_LEN_OTG_DESC							       0x05U
#endif
...
#define  USB_DESC_OTG						((USB_DESC_TYPE_OTG << 8) & 0xFF00U)
...
typedef struct _ConfigurationDescriptor
{
  ...
  uint8_t   bNumIntfAlt;       	  /* Number of Interfaces, include alternate item  */
