...
int main(void)
{
    ...
    printfS("Startup, RCH:0x%08x\n", RCC->RCHCR); 
    
//    RCC->AHB1CKENR &= ~BIT5; //CRC
//    RCC->APB1CKENR2 &= ~(BIT6|BIT7); 
//    RCC->APB2CKENR &= ~BIT9;
//    printfS("AHB1:0x%08x, AHB2:0x%08x, AHB3:0x%08x,\n", RCC->AHB1CKENR, RCC->AHB2CKENR, RCC->AHB3CKENR); 
//    
//    printfS("APB1:0x%08x, APB1_2:0x%08x, APB2:0x%08x, APB3:0x%08x,\n", RCC->APB1CKENR1, RCC->APB1CKENR2, RCC->APB2CKENR, RCC->APB3CKENR); 
...
//    USBOTG2_PHYC->CR = (BIT0 | BIT5 | BIT4);   
