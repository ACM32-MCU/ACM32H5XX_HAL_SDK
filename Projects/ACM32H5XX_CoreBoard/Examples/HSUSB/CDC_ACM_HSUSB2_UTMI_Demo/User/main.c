    ...
    {   
        ...
        switch (usb_request.bmRequest & USB_REQ_TYPE_MASK)
        {
            ...
            switch (usb_request.bRequest)
            {
                ...
                CDC_Acm_Set_Line_Coding(&USBD_Device, usb_request.wLength);    
                break;   
                ...
                CDC_Acm_Get_Line_Coding(&USBD_Device, usb_request.wLength);     
                break;   
...
int main(void)
{
    ...
    printfS("USB Interrupt Demo, CDC ACM, Max Packet is 512\n");  
    NVIC_EnableIRQ(USBOTG2_IRQn); 
    #else
    printfS("USB Poll Demo, CDC ACM, Max Packet is 512\n");     
    #endif 
    ...
    while(1) 
    {
      ...
      VCOM_Process_OutData();  
      VCOM_Process_InData(&USBD_Device);   
