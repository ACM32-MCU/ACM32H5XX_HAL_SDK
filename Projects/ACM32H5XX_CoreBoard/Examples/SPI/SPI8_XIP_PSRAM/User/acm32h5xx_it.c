...
//{
//    HAL_DMAC_IRQHandler(&DMA_SPIT_Handle);
//}

//void DMAC2_IRQHandler(void)
//{
//    HAL_DMAC_IRQHandler(&DMA_SPIR_Handle);
//}

void DMA1_CH0_IRQHandler(void)
{
    HAL_DMA_IRQHandler(&(get_psram_info()->hDMARx));
}

void DMA1_CH1_IRQHandler(void)
{
    HAL_DMA_IRQHandler(&(get_psram_info()->hDMATx));
}
