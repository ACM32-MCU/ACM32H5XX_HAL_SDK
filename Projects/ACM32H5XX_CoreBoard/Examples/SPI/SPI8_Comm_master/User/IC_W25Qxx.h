...
//#define __SPI_CS_Select()                         HAL_GPIO_WritePin(GPIOA, GPIO_PIN_15, GPIO_PIN_RESET)

#define __SPI_CS_Release()                        HAL_GPIO_WritePin(GPIOM, GPIO_PIN_1, GPIO_PIN_SET)

#define __SPI_CS_Select()                         HAL_GPIO_WritePin(GPIOM, GPIO_PIN_1, GPIO_PIN_RESET)
