...
extern TIM_HandleTypeDef Base_TIM_Handler;  
extern TIM_HandleTypeDef Advanced_TIM_Handler; 
extern TIM_HandleTypeDef General_16_TIM_Handler;   
extern TIM_HandleTypeDef General_32_TIM_Handler;   
...
{
    HAL_TIM_IRQHandler(&Advanced_TIM_Handler);    
}

void TIM2_IRQHandler(void)  
{
    HAL_TIM_IRQHandler(&General_32_TIM_Handler);     
}

void TIM3_IRQHandler(void)  
{
    HAL_TIM_IRQHandler(&General_16_TIM_Handler);      
}
...
{	
	HAL_TIM_IRQHandler(&Base_TIM_Handler);    
}
