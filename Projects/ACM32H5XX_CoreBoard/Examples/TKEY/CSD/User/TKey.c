...
void TKEY_Calibrate_ParaInit(void)
{
    ...
    for(ucI = 0; TKEY_Handle.ChannelData[ucI].ChannelId != 0xFFFF; ucI++)
    {
        ...
        TKEY_Handle.ChannelData[ucI].Tkey_CalData->CalFlag = TKEY_CALIBRAT_IDLE;
				//add 2024-8-26
				TKEY_Handle.ChannelData[ucI].Tkey_Data->Noise = 150;
    }
...
////        read_channel_data_single_16(&TKEY_Handle);
//        
//        read_channel_data_single_16_compensate(&TKEY_Handle);
//			//read_channel_data_single_16_compensate_reverse(&TKEY_Handle);
//			//read_channel_data_single_16_compensate_GND(&TKEY_Handle);
...
void TKEY_Suspend(void)
{
    ...
    TKEY_AutoConfigTypeDef TKEY_AutoConfig;

    
    /* 设置睡眠模式下的扫描间隔 */
    g16TkeyScanInterval = HAL_TKEY_ReadScanInterval(); 
    HAL_TKEY_ScanIntervalConfig(4000);
//        
//    TKEY_AutoConfig.Baseline[0] = TKEY_Handle.ChannelData[0].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[0].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[1] = TKEY_Handle.ChannelData[1].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[1].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[2] = TKEY_Handle.ChannelData[2].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[2].Predict_Touch_Delta * 9 / 10);
//    TKEY_AutoConfig.Baseline[3] = TKEY_Handle.ChannelData[3].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[3].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[4] = TKEY_Handle.ChannelData[4].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[4].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[5] = TKEY_Handle.ChannelData[5].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[5].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[6] = TKEY_Handle.ChannelData[6].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[6].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[7] = TKEY_Handle.ChannelData[7].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[7].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[8] = TKEY_Handle.ChannelData[8].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[8].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[9] = TKEY_Handle.ChannelData[9].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[9].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[10] = TKEY_Handle.ChannelData[10].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[10].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[11] = TKEY_Handle.ChannelData[11].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[11].Predict_Touch_Delta * 9 / 10);
//    TKEY_AutoConfig.Baseline[12] = TKEY_Handle.ChannelData[12].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[12].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[13] = TKEY_Handle.ChannelData[13].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[13].Predict_Touch_Delta * 9 / 10); 
//    TKEY_AutoConfig.Baseline[14] = TKEY_Handle.ChannelData[14].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[14].Predict_Touch_Delta * 9 / 10);  		
//	TKEY_AutoConfig.Baseline[15] = TKEY_Handle.ChannelData[15].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[15].Predict_Touch_Delta * 9 / 10);
    
    
        
    TKEY_AutoConfig.Baseline[0] = TKEY_Handle.ChannelData[0].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[0].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[1] = TKEY_Handle.ChannelData[1].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[1].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[2] = TKEY_Handle.ChannelData[2].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[2].Predict_Touch_Delta * 9 / 10)+1000;
    TKEY_AutoConfig.Baseline[3] = TKEY_Handle.ChannelData[3].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[3].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[4] = TKEY_Handle.ChannelData[4].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[4].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[5] = TKEY_Handle.ChannelData[5].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[5].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[6] = TKEY_Handle.ChannelData[6].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[6].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[7] = TKEY_Handle.ChannelData[7].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[7].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[8] = TKEY_Handle.ChannelData[8].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[8].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[9] = TKEY_Handle.ChannelData[9].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[9].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[10] = TKEY_Handle.ChannelData[10].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[10].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[11] = TKEY_Handle.ChannelData[11].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[11].Predict_Touch_Delta * 9 / 10)+1000;
    TKEY_AutoConfig.Baseline[12] = TKEY_Handle.ChannelData[12].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[12].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[13] = TKEY_Handle.ChannelData[13].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[13].Predict_Touch_Delta * 9 / 10)+1000; 
    TKEY_AutoConfig.Baseline[14] = TKEY_Handle.ChannelData[14].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[14].Predict_Touch_Delta * 9 / 10)+1000;  		
	TKEY_AutoConfig.Baseline[15] = TKEY_Handle.ChannelData[15].Tkey_Data->BaseLine +  (TKEY_Handle.ChannelData[15].Predict_Touch_Delta * 9 / 10)+1000;
    
    
//    /* 配置每个通道变化量 */
    TKEY_AutoConfig.Threshold[0] = 0;
    TKEY_AutoConfig.Threshold[1] = 0;
    TKEY_AutoConfig.Threshold[2] = 0;
    TKEY_AutoConfig.Threshold[3] = 0;
    TKEY_AutoConfig.Threshold[4] = 0;
    TKEY_AutoConfig.Threshold[5] = 0;
    TKEY_AutoConfig.Threshold[6] = 0;
    TKEY_AutoConfig.Threshold[7] = 0;
    TKEY_AutoConfig.Threshold[8] = 0;
    TKEY_AutoConfig.Threshold[9] = 0;
    TKEY_AutoConfig.Threshold[10] = 0;
    TKEY_AutoConfig.Threshold[11] = 0;
    TKEY_AutoConfig.Threshold[12] = 0;
    TKEY_AutoConfig.Threshold[13] = 0;
    TKEY_AutoConfig.Threshold[14] = 0;
    TKEY_AutoConfig.Threshold[15] = 0;
    
    /* 配置硬件滤波次数 */
    TKEY_AutoConfig.FilterNum = TKEY_FILTER_NONE;
//  /* 配置单论触摸按键个数 */
//    TKEY_AutoConfig.KeyNum = TKEY_AUTO_KEYNUM_1;
    /* 配置硬件滤波计数模式 */
    TKEY_AutoConfig.CountMode = TKEY_AUTO_COUNT_SINGLE;
    HAL_TKEY_AutoConfig(&TKEY_AutoConfig);
		
	//printf("2ba=%d %d\n", TKEY->CH[15]  ,TKEY->TH[15]);
    
    /* 禁止TKEY其它中断，以防其它中断唤醒 */    
    HAL_TKEY_ITConfig(TKEY_IT_ALL, DISABLE);  
    /* 清除所有标志 */
    HAL_TKEY_ClearFlag(TKEY_FLAG_ALL);
    /* 使能按键触摸中断中断 */
    HAL_TKEY_ITConfig(TKEY_IT_YESTOUCHIE, ENABLE);

    /* 设置EXTI触发源来自TKEY */
    __HAL_RCC_EXTI_CLK_ENABLE();
    HAL_EXTI_SetConfigLine(NULL, EXTI_LINE_TKEY, EXTI_MODE_IT_RISING);
//    NVIC_ClearPendingIRQ(EXTI22_16_IRQn);
//    NVIC_SetPriority(EXTI22_16_IRQn, 5);
//    NVIC_EnableIRQ(EXTI22_16_IRQn);

    /* 使能自动模式 */
    HAL_TKEY_AutoEnableDisable(ENABLE);
...
{
//    /* TKPCLK切换为TKPCLK */
//    HAL_PMU_StopTkeyPclkSwitchToRC4M(DISABLE);
//    
//    /* 关闭TKEYEN */
//    HAL_TKEY_EnableDisable(DISABLE); 
////    /* 使能TKEYEN */
////    HAL_TKEY_EnableDisable(ENABLE); 
//    
//    /* 禁止TKEY中断 */
...
//    
//    /* 清除EXTI触发源 */ 
//    HAL_EXTI_ClearConfigLine(EXTI_LINE_TKEY);  
//    /* 禁止按键触摸中断中断 */
//    HAL_TKEY_ITConfig(TKEY_IT_YESTOUCHIE, DISABLE);     
//    /* 清除所有中断标志 */
//    HAL_TKEY_ClearFlag(TKEY_FLAG_ALL);
//    /* 禁止自动模式 */
//    HAL_TKEY_AutoEnableDisable(DISABLE);
//    /* 设置为正常模式下的扫描间隔 */
//    HAL_TKEY_ScanIntervalConfig(g16TkeyScanInterval);      
//    /* 使能正常模式下开启的TKEY中断 */
...
void TKey_BaseLine_Init(TKEY_HandleTypeDef* htkey)
{
    ...
    {            
        HAL_TKEY_ReadChannelData_SingleAll_Compensate(&TKEY_Handle);
...
//				 if((sample_max[ucI] - htkey->ChannelData[ucI].Tkey_Data->BaseLine ) > htkey->ChannelData[ucI].Max_Noise)
//				 {
//							htkey->ChannelData[ucI].Tkey_Data->Noise = sample_max[ucI] - htkey->ChannelData[ucI].Tkey_Data->BaseLine;
//				 }
//				 else
//				 {
//				      htkey->ChannelData[ucI].Tkey_Data->Noise = htkey->ChannelData[ucI].Max_Noise;
//				 }
    }	   
}
	  ...
	  switch (TKEY_COVER_PLATE_THICKNESS)
		{
			...
			case 5:
						for(ucI = 0; TKEY_Handle.ChannelData[ucI].ChannelId != 0xFFFF; ucI++)
						{
							...
							{
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 300;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 1)
							{
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH =220;

							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 2)
							{
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 200;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 3)
							{
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 250;
							}
							...
							{
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 350;
					...
					break;
							...
							for(ucI = 0; TKEY_Handle.ChannelData[ucI].ChannelId != 0xFFFF; ucI++)
						{
							...
							{
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH =120;
							...
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 14)
							{
								...
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 150;

							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 15)
							{

								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 280;
							}
							else
							{
							  TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 120;
					...
					case 8:
							for(ucI = 0; TKEY_Handle.ChannelData[ucI].ChannelId != 0xFFFF; ucI++)
					   {
							...
							if(TKEY_Handle.ChannelData[ucI].ChannelId == 0)
							{
								...
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 260;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 1)
							{
								
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH =170;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 2)
							{
							
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 160;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 3)
							{
							...
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 4)
							{
								...
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 270;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 5)
							{
							...
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 8)
							{
								...
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 240;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 9)
							{
							
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 130;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 10)
							{
					
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 135;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 11)
							{
								
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 180;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 12)
							{
						
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 188;
							}
						    else if(TKEY_Handle.ChannelData[ucI].ChannelId == 13)
							{
								
								TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 186;
							}
							else if(TKEY_Handle.ChannelData[ucI].ChannelId == 14)
							{
							...
							{
							  TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH = 100;
							}
							TKEY_Handle.ChannelData[ucI].Tkey_Data->DetectOutTH = TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH * 80 / 100;
							TKEY_Handle.ChannelData[ucI].Delta_Sum = TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH << TKEY_Handle.ChannelData[ucI].Delta_Sum_Cnt;
							TKEY_Handle.ChannelData[ucI].Predict_Touch_Delta  = TKEY_Handle.ChannelData[ucI].Tkey_RefPara->DetectInTH;
...
void TKEY_ScanProcess(TKEY_HandleTypeDef* htkey)
{
    ...
    for (ucI = 0; htkey->ChannelData[ucI].ChannelId != 0xFFFF; ucI++)
    {
        ...
        htkey->ChannelData[ucI].Tkey_Data->Delta = (int32_t)htkey->ChannelData[ucI].Tkey_Data->RawData - (int32_t)htkey->ChannelData[ucI].Tkey_Data->BaseLine;
