...
#define PICTURE_DISP_TIME_MS					3000


#define LTDC_WIN_BUF_VALID_SIZE			(TEST_L1_AREA_WIDTH*TEST_L1_AREA_HEIGHT*4)


//disp memory locate to PSRAM
uint32_t ltdc_layer1_buf[LCD_MAX_LAYER_BUF_SIZE/4] OSPI1PSRAM;
uint32_t ltdc_layer2_buf[LCD_MAX_LAYER_BUF_SIZE/4] OSPI1PSRAM;

uint32_t ltdc_temp_buf1[LCD_MAX_LAYER_BUF_SIZE/4] OSPI1PSRAM;
uint32_t ltdc_temp_buf2[LCD_MAX_LAYER_BUF_SIZE/4] OSPI1PSRAM;
uint32_t ltdc_temp_buf3[LCD_MAX_LAYER_BUF_SIZE/4] OSPI1PSRAM;

uint32_t dma2d_front_layer_buf[LCD_MAX_LAYER_BUF_SIZE/4] OSPI1PSRAM;
uint32_t dma2d_back_layer_buf[LCD_MAX_LAYER_BUF_SIZE/4] OSPI1PSRAM;
...
void dma2d_line_evt_proc(void)
{
//	HAL_DMA2D_Suspend(&Dma2d_Handler);	//suspend test
